...
class Proposal(GovernanceClass, BaseModel):
    ...
    govobj_type = OMEGACOIND_GOVOBJ_TYPES['proposal']
    ...
    def is_valid(self):
        ...
        try:
            ...
            # OmegaCoinCore restricts proposals to 512 bytes max
...
class Superblock(BaseModel, GovernanceClass):
    ...
    govobj_type = OMEGACOIND_GOVOBJ_TYPES['superblock']
